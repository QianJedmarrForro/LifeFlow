    ...
    <div class="page-main-container">
        ...
        <div class="lf-page-header">
            ...
            <div style="font-weight: 600; color: #64748b;">
                {{ now()->format('F d, Y') }} <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:middle;"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
            </div>
        </div>
